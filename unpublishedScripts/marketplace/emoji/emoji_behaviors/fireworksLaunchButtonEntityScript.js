  ...
  (function() {
    Script.include("http://rawgit.com/ericrius1/hifi/playaFireworks/examples/libraries/utils.js");
    var _this;
    Fireworks = function() {
      _this = this;
    ...
    Fireworks.prototype = {
      ...
      shootMissle: function(launchPosition) {
        ...
        var missleRotation = Quat.fromPitchYawRollDegrees(0, 0, 0);
        var missleVelocity = Vec3.multiply(Quat.getUp(missleRotation), randFloat(2.75, 3.25));
        var missleAcceleration = Vec3.multiply(Quat.getUp(missleRotation), 2);
        ...
        Script.setTimeout(function() {
          ...
          var numAdditionalFireworks = randInt(2, 5);
          for (var i = 0; i < numAdditionalFireworks; i++) {
            Script.setTimeout(function() {
              var explodePosition = Vec3.sum(explodeBasePosition, {x: randFloat(-1, 1), y: randFloat(-1, 1), z: randFloat(-5, 5)});
